...
import { <%= classify(name) %>, <%= classify(name) %>Props } from '../../../../domain/entities/<%= dasherize(name) %>/models/<%= dasherize(name) %>.entity';
import { <%= classify(name) %>Repository } from '../../../../domain/repositories/<%= dasherize(name) %>/interfaces/<%= dasherize(name) %>.repository';
import { <%= classify(name) %>Datasource } from '../../../datasources/<%= dasherize(name) %>/implementations/<%= dasherize(name) %>.datasource';
