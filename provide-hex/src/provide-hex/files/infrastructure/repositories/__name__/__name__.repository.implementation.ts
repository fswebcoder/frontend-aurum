...
import { <%= classify(name) %>, <%= classify(name) %>Props } from '../../../domain/entities/<%= dasherize(name) %>/<%= dasherize(name) %>.entity';
import { <%= classify(name) %>Repository } from '../../../domain/repositories/<%= dasherize(name) %>/<%= dasherize(name) %>.repository';
import { <%= classify(name) %>Datasource } from '../../datasources/<%= dasherize(name) %>/<%= dasherize(name) %>.datasource';
